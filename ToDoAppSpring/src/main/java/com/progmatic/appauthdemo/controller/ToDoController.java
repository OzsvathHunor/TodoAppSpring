...
//    @Autowired
    ...
    public String saveRegistration(
        ...
        BindingResult bind
            ...
            appUser.setFirstName(registrationForm.getFirstName());
            appUser.setLastName(registrationForm.getLastName());
            appUser.setEmail(registrationForm.getEmail());
            appUser.setPassword(BCrypt.hashpw(registrationForm.getPassword(), BCrypt.gensalt()));
